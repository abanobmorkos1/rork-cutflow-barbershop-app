...
import { Save, Instagram, Award, Tag } from 'lucide-react-native';
...
const styles = StyleSheet.create({
  ...
  avatar: {
    width: 88, height: 88, borderRadius: 28, backgroundColor: Colors.surface,
    marginBottom: 12, borderWidth: 2, borderColor: Colors.accent,
  },
  barberName: { fontSize: 22, fontWeight: '700' as const, color: Colors.text },
  barberEmail: { fontSize: 14, color: Colors.textSecondary, marginTop: 4 },
  section: {
  ...
  sectionDesc: { fontSize: 13, color: Colors.textSecondary, marginBottom: 14, marginTop: 4 },
  tagCount: { fontSize: 13, fontWeight: '600' as const, color: Colors.accent },
  tagsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  tagChip: {
    paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20,
    backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border,
  },
  tagChipSelected: { backgroundColor: 'rgba(200,149,108,0.15)', borderColor: Colors.accent },
  tagText: { fontSize: 13, fontWeight: '600' as const, color: Colors.textSecondary },
  tagTextSelected: { color: Colors.accent },
  bioInput: {
    backgroundColor: Colors.surface, borderRadius: 12, padding: 14,
    color: Colors.text, fontSize: 15, minHeight: 100,
    borderWidth: 1, borderColor: Colors.border, lineHeight: 22, marginTop: 8,
  },
  charCount: { fontSize: 11, color: Colors.textMuted, textAlign: 'right' as const, marginTop: 6 },
  fieldRow: { flexDirection: 'row', alignItems: 'center', gap: 14, marginBottom: 14 },
  fieldIconWrap: {
  ...
  saveBtn: {
    ...
    backgroundColor: Colors.accent, height: 54, borderRadius: 14, gap: 8, marginTop: 8,
  },
