...
import { getCalendarDays, MONTH_NAMES, WEEKDAY_HEADERS, toDateStr, getBarberSlotsForDate, formatDateDisplay } from '@/utils/slots';
...
const styles = StyleSheet.create({
  ...
  calCellAvailable: { backgroundColor: 'rgba(76,175,80,0.12)', borderRadius: 10 },
  calCellOverride: { backgroundColor: 'rgba(33,150,243,0.12)', borderRadius: 10 },
  calCellOff: { backgroundColor: 'transparent' },
  ...
  overrideDot: {
    width: 4, height: 4, borderRadius: 2, backgroundColor: Colors.info,
  ...
  removeOverrideBtn: {
    backgroundColor: 'rgba(229,57,53,0.1)', paddingHorizontal: 14, paddingVertical: 8,
    borderRadius: 8, alignSelf: 'flex-start' as const, marginBottom: 12,
  },
  removeOverrideText: { fontSize: 13, fontWeight: '600' as const, color: Colors.error },
  overrideTimeRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 14 },
  overrideTimeInput: {
    flex: 1, flexDirection: 'row', alignItems: 'center',
    backgroundColor: Colors.surface, borderRadius: 10, paddingHorizontal: 12,
    height: 42, borderWidth: 1, borderColor: Colors.border, gap: 8,
  },
  ...
  dayToggleActive: { backgroundColor: 'rgba(200,149,108,0.2)', borderColor: Colors.accent },
  dayToggleInner: { width: 18, height: 18, borderRadius: 9, backgroundColor: Colors.textMuted },
  dayToggleInnerActive: { backgroundColor: Colors.accent, alignSelf: 'flex-end' as const },
  dayName: { flex: 1, fontSize: 16, fontWeight: '600' as const, color: Colors.textMuted },
  dayNameActive: { color: Colors.text },
  offLabel: { fontSize: 12, fontWeight: '700' as const, color: Colors.textMuted, letterSpacing: 1 },
  ...
  saveBtn: {
    ...
    backgroundColor: Colors.accent, height: 54, borderRadius: 14, gap: 8, marginTop: 16,
  },
